...
CNapalmBombHitLand01 = {
    EmtBpPath .. 'napalm_hvy_flash_emit.bp',
    ModBpPath .. 'cybran_napalm_thick_smoke_emit.bp',
    ModBpPath .. 'cybran_napalm_thin_smoke_emit.bp',
    ModBpPath .. 'cybran_napalm_01_emit.bp',
    EmtBpPath .. 'napalm_hvy_02_emit.bp',
    EmtBpPath .. 'napalm_hvy_03_emit.bp',
}
CNapalmBombHitWater01 = {
